...
export default function InspectionSection() {
  ...
  <section aria-label="32-Point Unrelenting Standard" className="py-16 md:py-24 bg-[#02066f] text-[#f1ece4] overflow-hidden">
    <div className="w-content-width mx-auto">
      ...
      {/* Scope Row */}
      <ScrollReveal variant="fade-blur" delay={0.2} className="mb-16">
      ...
      {/* Guarantee Band & CTA */}
      <ScrollReveal variant="slide-up" delay={0.3} className="max-w-3xl mx-auto text-center">
        {/* Guarantee Div - Off-white background with dark blue text */}
        <div className="bg-[#f1ece4] border-t-2 border-[#bf9945] rounded-xl p-8 md:p-10 text-center shadow-lg mb-10">
          <h3 className="text-xl md:text-2xl font-semibold text-[#02066f] mb-3">
            Maintained Between Visits
          </h3>
          <p className="text-sm md:text-base text-[#02066f]/90 leading-relaxed max-w-2xl mx-auto mb-4">
